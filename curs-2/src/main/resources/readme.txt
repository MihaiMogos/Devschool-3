ATM Console Application
 - Flow:
        ...
        - If the Account is found then the user cand perform 4 actions: View my balance; Deposit;Withdrawal; Exit
        ...
        - Actions:
                ...
                - Deposit - > the user is asked to enter an amount, and that amount is added to the balance
                              of the account he is authenticated for
                - Withdrawal -> the user is asked to select an amount from a list, and if the cash Dispense has enough
        ...
        -Use Cases:
            ...
            - An ATM allows a user to perform a Transaction only if the user is authenticated with acc nr and pin
            ...
            - The Deposit transaction should give the user the possibility to credit the account
